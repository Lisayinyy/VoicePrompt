...
2. 从 [v0.7.0-beta.1 内测发布页](https://github.com/Lisayinyy/VoicePrompt/releases/tag/v0.7.0-beta.1) 下载 `voice-prompt-setup-0.7.0.zip` 与 `SHA256SUMS`，校验 setup ZIP，解压到用户可写的独立工作目录。不要改写已导入插件的只读目录。发布页的 SHA256SUMS 与 HTTPS 发布来源一起使用。
