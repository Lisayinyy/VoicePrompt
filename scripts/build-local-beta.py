...
sources = ["VoicePrompt.swift", "VoicePromptUI.swift", "VoiceHotkey.swift", "VoiceDirectEdit.swift", "VoicePasteboard.swift", "VoiceInputGuard.swift", "VoiceLivePreview.swift", "VoiceAppAppearance.swift"]
...
info.update(CFBundleShortVersionString="0.7.0", CFBundleVersion="23")
(contents / "Info.plist").write_bytes(plistlib.dumps(info))
manifest = json.loads((resources / "components.json").read_text())
manifest.update(version="0.7.0", liveTranscriptPreview=True, optionalLocalASR={"name": "Qwen3-ASR-1.7B-8bit", "revision": "a8379a2e2f9e313c9292cdf1af4055ab56d50d55", "engine": "mlx-audio 0.5.3", "bundled": False, "setup": "scripts/setup-local-asr.py"})
