...
sources = ["VoicePrompt.swift", "VoicePromptUI.swift", "VoiceHotkey.swift", "VoiceDirectEdit.swift", "VoicePasteboard.swift", "VoiceInputGuard.swift", "VoiceLivePreview.swift"]
...
info.update(CFBundleShortVersionString="0.7.0", CFBundleVersion="17")
